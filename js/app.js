...
var translations = {
  ...
  pl: {
    ...
    publish_btn: 'Publikuj na Stronę',
    ...
    publish_err: 'Publikowanie nie powiodło się.',
    ...
    feat_crud_desc: 'Twórz, edytuj, usuwaj, eksportuj i importuj projekty z obsługą dziennika zmian i publikacją na GitHub.',
    ...
    why_phil_6: 'GitHub-natywny — publikuj i synchronizuj przez API GitHub',
...
function showProjectDetail(id) {
  ...
  var links = [['github_url', 'source_code'], ['download_url', 'download'], ['website_url', 'website'], ['docs_url', 'detail_links']];
